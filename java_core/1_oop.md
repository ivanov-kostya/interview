...
### 7. Можно ли создать экземпляр абстрактного класса? Как работать с абстрактными классами?

### 8. В чем разница между статическим и динамическим связыванием?

### 9. Что такое множественное наследование? Как оно реализовано в Java?
...
### 15. Принцип единственной ответственности (Single Responsibility Principle) - что это и примеры?

### 16. Принцип открытости/закрытости (Open/Closed Principle) - что это и примеры?

### 17. Принцип подстановки Лисков (Liskov Substitution Principle) - что это и примеры?

### 18. Принцип разделения интерфейса (Interface Segregation Principle) - что это и примеры?

### 19. Принцип инверсии зависимостей (Dependency Inversion Principle) - что это и примеры?

### 20. Что такое абстракция? Как она реализуется в Java?

### 21. В чем разница между агрегацией и композицией?

### 22. Что такое cohesion и coupling? Почему важно учитывать эти концепции?

### 23. Что такое паттерны проектирования и зачем они нужны?

### 24. В чем преимущества и недостатки ООП?

### 25. Когда лучше использовать абстрактные классы, а когда интерфейсы?

### 26. Что такое маркерные интерфейсы? Приведите примеры.

### 27. Как работает позднее связывание в Java?

### 28. Что такое инкапсуляция на уровне пакета?

### 29. Как реализовать множественное наследование в Java?

### 30. Что такое diamond problem и как Java решает эту проблему?