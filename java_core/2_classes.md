...
### 5. Правила переопределения equals(). Требования к реализации.

### 6. Как правильно реализовать hashCode()? Способы генерации хэш-кода.

### 7. Метод clone(): назначение, проблемы, альтернативы.

### 8. В чем разница между поверхностным и глубоким клонированием?

### 9. Для чего используются методы wait(), notify() и notifyAll() в классе Object?

### 10. В чем особенности локальных классов? Какие ограничения на них накладываются?

### 11. Когда лучше использовать анонимные классы, а когда лямбда-выражения?

### 12. Какие есть ограничения на внутренние классы? Что они могут, а что нет?

### 13. Может ли внутренний класс иметь статические члены? Почему?

### 14. В чем разница между методами getClass() и Class.forName()?

### 15. Как работает метод toString() в Object? Какие правила его переопределения?

### 16. Что такое finalize()? Почему его использование не рекомендуется в современной Java?

### 17. Как связаны equals() и == ? В чем их принципиальная разница?

### 18. Что произойдет, если не переопределить equals(), но переопределить hashCode()?

### 19. Какие проблемы могут возникнуть при использовании вложенных классов?

### 20. Можно ли переопределить методы класса Object в final классе?